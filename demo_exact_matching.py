...
def demo_exact_matching():
    ...
    gl_data.to_csv('sample_data/sample_gl.csv', index=False)
    bank_data.to_csv('sample_data/sample_bank.csv', index=False)
    
    print("📁 Sample data files created:")
    print("  - sample_data/sample_gl.csv")
    print("  - sample_data/sample_bank.csv")
    print()
    ...
    print("🔧 Usage Example:")
    print("python -m src.main exact-match sample_data/sample_gl.csv sample_data/sample_bank.csv")
    ...
    print("✨ Demo completed! Ready to test exact matching reconciliation.")
